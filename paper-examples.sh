...
# Load SageMath and Magma on the SCC node
module load sagemath/9.3
module load magma_usyd/2.26-10

# This is the folder where the output files will be written.
...
# Run the Magma file generated by the above script due to the --unconditional flag
